...
# label_dict = {0: 'can', 1: 'hear', 5: 'hello', 3: 'help', 4: 'I', 12: 'love', 6: 'need', 7: 'please', 8: 'see', 9: 'speak', 10: 'watch', 11: 'we', 2: 'you'}

# count = 0

# input_shape = (TOTAL_FRAMES, 80, 112, 3)

# model = tf.keras.models.load_model('lip_read_model_v0_2_0.keras')
...
#                 print every probability per class/word
#                 prob_per_class = []
...
#     cv2.imshow(winname="LIPMIC APP", mat=frame)
